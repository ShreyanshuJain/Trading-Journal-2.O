  ...
  return (
    <div className="pb-20 lg:pb-12">
      ...
      <div className="px-4 md:px-6 space-y-6">
        {/* Metric Cards Grid (4 cols desktop, 2 cols tablet, 1-2 cols mobile) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Card 1: Net P/L */}
          <div className="bg-[#15181D] border border-[#292D33] rounded-xl p-4 flex flex-col justify-between">
            ...
            <div className="mt-2">
              ...
              <div className="text-[11px] text-[#6F7680] mt-1 flex items-center gap-2">
          ...
          <div className="bg-[#15181D] border border-[#292D33] rounded-xl p-4 flex flex-col justify-between">
            ...
            <div className="mt-2">
              ...
              <div className="text-[11px] text-[#6F7680] mt-1 flex items-center gap-1.5">
          ...
          <div className="bg-[#15181D] border border-[#292D33] rounded-xl p-4 flex flex-col justify-between">
            ...
            <div className="mt-2">
              ...
              <div className="text-[11px] text-[#6F7680] mt-1">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="bg-[#1B1F24] border border-[#292D33] rounded-lg p-3">
            <span className="text-[10px] text-[#6F7680] uppercase tracking-wider block font-semibold">
              Total Trades
            </span>
            <span className="text-base font-bold text-[#F5F5F5]">{dashboardStats.totalTrades}</span>
            <span className="text-[10px] text-[#A0A6AE] ml-2">({dashboardStats.openTrades} Open)</span>
          </div>
        ...
        <div className="bg-[#15181D] border border-[#292D33] rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-base font-bold text-[#F5F5F5]">Recent Recorded Trades</h2>
              <p className="text-xs text-[#A0A6AE]">Latest trading journal entries</p>
            </div>

            <button
              onClick={() => setIsAddTradeOpen(true)}
              className="py-1.5 px-3 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-medium flex items-center gap-1 transition-all cursor-pointer"
            >
