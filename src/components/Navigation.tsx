  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-[#15181D] border-r border-[#292D33] min-h-screen fixed left-0 top-0 bottom-0 z-30">
        {/* Logo & Brand Header */}
        <div className="p-5 border-b border-[#292D33] flex items-center justify-between">
        ...
        <div className="p-4 space-y-2 border-b border-[#292D33]">
          ...
          >
            ...
            <kbd className="px-1.5 py-0.5 rounded bg-[#0D0F12] border border-[#292D33] text-[10px] text-[#6F7680]">
              ⌘K
            </kbd>
          </button>
        </div>
        ...
        <div className="p-4 border-t border-[#292D33] bg-[#0D0F12]/50">
